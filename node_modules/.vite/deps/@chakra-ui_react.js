...
} from "./chunk-Z3ERMIXS.js";
import {
  _extends
} from "./chunk-YRPD5PNG.js";
import {
  require_jsx_runtime
...
function useCallbackRef3(fn, deps = []) {
  const ref = (0, import_react98.useRef)(fn);
...
var useUpdateEffect2 = (effect3, deps) => {
...
function usePopper(props = {}) {
  ...
  const reference = (0, import_react132.useRef)(null);
  const popper = (0, import_react132.useRef)(null);
  ...
  const setupPopper = (0, import_react132.useCallback)(() => {
    ...
    instance.current = createPopper2(reference.current, popper.current, {
      placement,
      modifiers: [
        innerArrow,
        positionArrow,
